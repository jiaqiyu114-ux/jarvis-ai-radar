...
import type { Category, SourceTier } from "@/types"
      ...
      <div className="p-6 md:p-8">
        ...
        <div className="mb-5">
          ...
          <div className="flex items-end justify-between gap-4">
            ...
            <p className="meta-text pb-0.5">{mockItems.length} 条 · 最近 48h</p>
          </div>
        </div>

        {/* ── Filter bar — no heavy card border, just a bottom separator ── */}
        ...
        {/* ── Feed list — no outer border, cards use their own border-b ── */}
